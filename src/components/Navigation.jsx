...
const Navigation = () => {
  ...
  return (
    <>
      {/* Progress bar with increased z-index to ensure visibility */}
      <div className="fixed bottom-0 left-0 right-0 z-[100] h-1 w-full pointer-events-none">
        <div 
          className="h-full bg-gradient-to-r from-violet-600 via-indigo-700 to-blue-800 shadow-[0_0_8px_rgba(139,92,246,0.6)] transition-all duration-300 ease-out" 
